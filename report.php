...
<!-----------------------------imgslider------------------------------------------------------------------------------------------------------>
	<div class="row">
		<div class="col-sm-8">
			<a href=#dischargelink><input type="button" class="form-control"value="Discharge Report" id="discharge" style="background-color:#f8c291"/>
			<br><br></a>
			<a href=#powerlink><input type="button" class="form-control"value="Power Report" id="power" style="background-color:#ff7979"/>
			<br><br></a>
			<a href=#rainlink><input type="button" class="form-control"value="Rainfall Report" id="rainfall" style="background-color:#67e6dc"/>
			<br><br></a>
		</div>
		<div class="col-sm-4">
	...
	<a id=dischargelink>
		<div class="col-sm-4">
			<input href=#dailylink type="submit" class="form-control"value="Daily Report" id="daily" style="background-color:#f8c291"/>
		</div>
		<div class="col-sm-4">		
			<input href=#monthlylink type="submit" class="form-control"value="Monthly Report" id="Monthly" style="background-color:#f8c291"/>
		</div>
		<div class="col-sm-4">		
			<input href=#yearlylink type="submit" class="form-control"value="Yearly Report" id="yearly" style="background-color:#f8c291"/>
		</div>
	</a>
		<a id=powerlink>
			<div class="col-sm-4">
				<input type="submit" class="form-control"value="Daily Report" id="daily" style="background-color:#ff7979"/>
			</div>
			<div class="col-sm-4">		
				<input type="submit" class="form-control"value="Monthly Report" id="Monthly" style="background-color:#ff7979"/>
			</div>
			<div class="col-sm-4">		
				<input type="submit" class="form-control"value="Yearly Report" id="yearly" style="background-color:#ff7979"/>
			</div>
		</a>
		<a id=rainlink>
			<div class="col-sm-4">
				<input type="submit" class="form-control"value="Daily Report" id="daily" style="background-color:#67e6dc"/>
			</div>
			<div class="col-sm-4">		
				<input type="submit" class="form-control"value="Monthly Report" id="Monthly" style="background-color:#67e6dc"/>
			</div>
			<div class="col-sm-4">		
				<input type="submit" class="form-control"value="Yearly Report" id="yearly" style="background-color:#67e6dc"/>
			</div>
		</a>
