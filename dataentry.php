...
<!-----------------------------imgslider------------------------------------------------------------------------------------------------------>
    ...
    <div class="col-sm-4" style="padding:2em">
		<div class="well" style="border:.2em solid #192A56">
			<br>
			<a href="dischargeentry.php" class="btn btn-lg btn-success">Discharge Data</a>
			<br><br>
			<a href="rainfall.php" class="btn btn-lg btn-success">Rain Entry</a>
			<br><br>
			<a href="turbine_status.php" class="btn btn-lg btn-success" >Turbine Entry</a>
			<br><br>
	</div>
	</div>
	</div>
