...
<!-----------------------------imgslider------------------------------------------------------------------------------------------------------>
    ...
    <div class="col-sm-4" style="padding:2em">
		<div class="well" style="border:.2em solid #192A56">
			<br>
			<a href="" class="btn btn-lg btn-success" >View Admin</a>
			&nbsp;&nbsp;&nbsp;&nbsp;
			<a href="formadmin_add.php" class="btn btn-lg btn-success">Add Admin</a>
			<br><br>
			<a href="formadmin_delete.php" class="btn btn-lg btn-success">Delete Admin</a>
			&nbsp;&nbsp;
			<a href="report_main.php" class="btn btn-lg btn-success">View Report</a>
			<br><br>
	</div>
	</div>
	</div>
