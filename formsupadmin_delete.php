...
<div class="container">
  <h2>Delete Super Admin</h2>
  <form class="form-horizontal" action="" method="post">
    <div class="form-group">
      <label class="control-label col-sm-2">Select Superadmin from list: </label>
      <div class="col-sm-5">
        <select name="superadmin">
<?php 
include('conn2.php');
$sql = "select Name from login_table where role='superadmin'";
...
<?php
	...
	{
		$name=$_POST['superadmin'];
		include('conn2.php');
		$query="DELETE FROM login_table WHERE Name='$name'";
		echo $query;
	...
	<script language="javascript">
		alert("Moderator Successfully Deleted");
