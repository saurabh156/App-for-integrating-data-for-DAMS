...
<!-----------------------------imgslider------------------------------------------------------------------------------------------------------>
    ...
    <div class="col-sm-4" style="padding:2em">
		<div class="well" style="border:.2em solid #192A56">
			<br>
			<a href="view_super.php" class="btn btn-md btn-success" >View Super Admin</a>
			&nbsp;&nbsp;&nbsp;
			<a href="notice_add.php" class="btn btn-md btn-success">Add Notice</a>
			<br><br>
			<a href="formsupadmin_add.php" class="btn btn-md btn-success">Add Super Admin</a>
			&nbsp;&nbsp;&nbsp;
			<a href="notice_delete.php" class="btn btn-md btn-success">Delete Notice</a>
			<br><br>
			<a href="formsupadmin_delete.php" class="btn btn-md btn-success">Delete Super Admin</a>
	...
	<div id="hpage_latest">
				...
				<tr border=0>
					<td border=0>
					<p align="center"><strong>BRAHMAPUTRA RIVER</strong>
					<p>This will give inormation about the BRAHMAPUTRA of ARUNACHAL PRADESH</p>
					<p class="readmore"><a href="#">Continue Reading &raquo;</a></p>
					</p>
					</td>
					<td border=0>
					<p align="center"><strong>LOHIT RIVER</STRONG>
					<p>This will give inormation about the river 2 of ARUNACHAL PRADESH</p>
					<p class="readmore"><a href="#">Continue Reading &raquo;</a></p>
					</p>
					</td>
					<td border=0>	
					<p align="center"><strong>KAMENG RIVER</strong>
					<p>This will give inormation about the river 3 of ARUNACHAL PRADESH</p>
					<p class="readmore"><a href="#">Continue Reading &raquo;</a></p>
					</p>
					</td>
				</tr>
...
<!-----------------------------bottom---------------------------------------------------------------------------------------------------->
		...
		<h2 style="padding:2em" align="center">Upcoming projects </h2>
